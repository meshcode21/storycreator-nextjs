...
function ArchivesViewInner() {
  ...
  // Sub-tab now lives in the URL: /archives?type=motion or ?type=stills
  const subTab = (searchParams.get('type') === 'stills' ? 'stills' : 'motion') as 'motion' | 'stills';

  const setSubTab = (tab: 'motion' | 'stills') => {
      ...
      <div className="text-center max-w-4xl mx-auto mb-16 space-y-4">
        ...
        <div className="pt-10 flex justify-center items-center space-x-12">
          <button
            ...
            className={`font-sans text-xs uppercase tracking-[0.35em] transition-all pb-2 relative cursor-pointer ${
              subTab === 'motion' ? 'text-primary font-bold' : 'text-on-surface-variant hover:text-on-surface'
            }`}
          >
            [ Motion ]
            {subTab === 'motion' && (
          ...
          <button
            ...
            className={`font-sans text-xs uppercase tracking-[0.35em] transition-all pb-2 relative cursor-pointer ${
              subTab === 'stills' ? 'text-primary font-bold' : 'text-on-surface-variant hover:text-on-surface'
            }`}
          >
            [ Stills ]
            {subTab === 'stills' && (
